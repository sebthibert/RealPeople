...
var post = function(formData) {
  var oauth = OAuth({
    consumer: {
      key: '76a0f17108c61cd6722c196acf32fef5',
      secret: '6dc0d51eefbdbacd'
    },
  ...
  var token = {
    key: '72157685770664455-cff304ec50112857',
    secret: '3db74fa3bcf10f09'
  };
...
var previewFile = function(event) {
  ...
  form_data.append("cheese", URL.createObjectURL(event.target.files[0]));
  post(form_data);
};
